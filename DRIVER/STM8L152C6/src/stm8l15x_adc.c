...
/**
  ...
  *         @ref ADC_AnalogWatchdogSelection_T enumeration.
  * @retval None
  */
...
/**
  ...
  * @retval None
  */
void ADC_AnalogWatchdogThresholdsConfig(ADC_T* ADCx, uint16_t HighThreshold, uint16_t LowThreshold)
{
  /* Check the parameters */
...
/**
  ...
  * @retval None
  */
void ADC_ChannelCmd(ADC_T* ADCx, ADC_Channel_T ADC_Channels, FunctionalState NewState)
{
  uint8_t regindex = 0;
  /* Check the parameters */
  assert_param(IS_FUNCTIONAL_STATE(NewState));
...
/**
  ...
  * @retval None
  */
void ADC_SamplingTimeConfig(ADC_T* ADCx,
                            ADC_Group_T ADC_GroupChannels,
...
/**
  ...
  * @retval None
  */
void ADC_ITConfig(ADC_T* ADCx, ADC_IT_T ADC_IT, FunctionalState NewState)
{
  /* Check the parameters */
  assert_param(IS_FUNCTIONAL_STATE(NewState));
...
/**
  ...
  */
ITStatus ADC_GetITStatus(ADC_T* ADCx,
                         ADC_IT_T ADC_IT)
{
...
/**
  ...
  * @retval None
  */
void ADC_ClearITPendingBit(ADC_T* ADCx,
                           ADC_IT_T ADC_IT)
{
  uint8_t itmask = 0;
