...
/**
  ...
  * @retval None
  */
void I2C_Init(I2C_T* I2Cx, uint32_t OutputClockFrequency, uint16_t OwnAddress,
              I2C_Mode_T I2C_Mode, I2C_DutyCycle_T I2C_DutyCycle,
              I2C_Ack_T I2C_Ack, I2C_AcknowledgedAddress_T I2C_AcknowledgedAddress)
{
...
/**
  ...
  * @retval None
  */
void I2C_GenerateSTART(I2C_T* I2Cx, FunctionalState NewState)
{
...
/**
  ...
  * @retval None
  */
void I2C_SoftwareResetCmd(I2C_T* I2Cx, FunctionalState NewState)
{
  /* Check function parameters */
  assert_param(IS_FUNCTIONAL_STATE(NewState));
...
/**
  ...
  * @retval None
  */
void I2C_StretchClockCmd(I2C_T* I2Cx, FunctionalState NewState)
{
  /* Check function parameters */
  assert_param(IS_FUNCTIONAL_STATE(NewState));
...
/**
  ...
  * @retval None
  */
void I2C_ARPCmd(I2C_T* I2Cx, FunctionalState NewState)
{
  /* Check function parameters */
  assert_param(IS_FUNCTIONAL_STATE(NewState));
...
/**
  ...
  * @retval None.
  */
void I2C_OwnAddress2Config(I2C_T* I2Cx, uint8_t Address)
{
  uint8_t tmpreg = 0;
...
/**
  ...
  * @retval None
  */
void I2C_DualAddressCmd(I2C_T* I2Cx, FunctionalState NewState)
{
  /* Check the parameters */
  assert_param(IS_FUNCTIONAL_STATE(NewState));
...
/**
  ...
  * @retval None
  */
void I2C_AckPositionConfig(I2C_T* I2Cx, I2C_AckPosition_T I2C_AckPosition)
{
  /* Check function parameters */
...
/**
  ...
  * @retval None
  */
void I2C_SMBusAlertConfig(I2C_T* I2Cx, I2C_SMBusAlert_T I2C_SMBusAlert)
{
...
/**
  ...
  * @retval None
  */
void I2C_Send7bitAddress(I2C_T* I2Cx, uint8_t Address, I2C_Direction_T I2C_Direction)
{
  /* Check function parameters */
...
/**
  ...
  * @retval None
  */
void I2C_TransmitPEC(I2C_T* I2Cx, FunctionalState NewState)
{
  /* Check the parameters */
  assert_param(IS_FUNCTIONAL_STATE(NewState));
...
/**
  ...
  * @retval None
  */
void I2C_CalculatePEC(I2C_T* I2Cx, FunctionalState NewState)
{
  /* Check the parameters */
  assert_param(IS_FUNCTIONAL_STATE(NewState));
...
/**
  ...
  * @retval None
  */
void I2C_PECPositionConfig(I2C_T* I2Cx, I2C_PECPosition_T I2C_PECPosition)
{
  /* Check the parameters */
...
/**
  ...
  * @retval None
  */
void I2C_DMALastTransferCmd(I2C_T* I2Cx, FunctionalState NewState)
{
  /* Check the parameters */
  assert_param(IS_FUNCTIONAL_STATE(NewState));
...
/**
  ...
  * @retval None
  */
void I2C_ITConfig(I2C_T* I2Cx, I2C_IT_T I2C_IT, FunctionalState NewState)
{
  /* Check functions parameters */
...
uint8_t I2C_ReadRegister(I2C_T* I2Cx, I2C_Register_T I2C_Register)
{
  __IO uint16_t tmp = 0;
  /* Check the parameters */
...
/**
  ...
  */
ErrorStatus I2C_CheckEvent(I2C_T* I2Cx, I2C_Event_T I2C_Event)
{
...
/**
  ...
  */
I2C_Event_T I2C_GetLastEvent(I2C_T* I2Cx)
{
...
/**
  ...
  */
FlagStatus I2C_GetFlagStatus(I2C_T* I2Cx, I2C_FLAG_T I2C_FLAG)
{
  uint8_t tempreg = 0;
  uint8_t regindex = 0;
...
/**
  ...
  */
ITStatus I2C_GetITStatus(I2C_T* I2Cx, I2C_IT_T I2C_IT)
{
...
/**
  ...
  * @retval None
  */
void I2C_ClearITPendingBit(I2C_T* I2Cx, I2C_IT_T I2C_IT)
{
  uint16_t flagpos = 0;
