...
@verbatim   
 ...
 ===============================================================================  
   ...
   - FLASH_ProgramTime_T FLASH_GetProgrammingTime(void);
   - void FLASH_SetProgrammingTime(FLASH_ProgramTime_T FLASH_ProgTime);
	 - void FLASH_PowerWaitModeConfig(FLASH_Power_T FLASH_Power);
...
FLASH_ProgramTime_T FLASH_GetProgrammingTime(void)
{
  return((FLASH_ProgramTime_T)(FLASH->CR1 & FLASH_CR1_FIX));
}
...
@verbatim   
 ...
 ===============================================================================  
   ...
   The FLASH Memory Programming functions, includes the following functions:
    ...
    - void FLASH_Unlock(FLASH_MemType_T FLASH_MemType);
    - void FLASH_Lock(FLASH_MemType_T FLASH_MemType);
...
/**
  ...
  */
FlagStatus FLASH_GetFlagStatus(FLASH_FLAG_T FLASH_FLAG)
{
...
/**
  ...
  * @retval None
  */
IN_RAM(void FLASH_PowerRunModeConfig(FLASH_Power_T FLASH_Power))
{
  /* Check parameter */
  assert_param(IS_FLASH_POWER(FLASH_Power));
...
/**
  ...
  */
IN_RAM(FLASH_PowerStatus_T FLASH_GetPowerStatus(void))
{
  return((FLASH_PowerStatus_T)(FLASH->CR1 & (uint8_t)0x0C));
}
...
/**
  ...
  * @retval None.
  */
IN_RAM(void FLASH_ProgramBlock(uint16_t BlockNum, FLASH_MemType_T FLASH_MemType,
                        FLASH_ProgramMode_T FLASH_ProgMode, uint8_t *Buffer))
{
  uint16_t Count = 0;
...
/**
  ...
  * @retval None.
  */
IN_RAM(void FLASH_EraseBlock(uint16_t BlockNum, FLASH_MemType_T FLASH_MemType))
{
  uint32_t startaddress = 0;
...
/**
  ...
  * @retval FLASH status
  */
IN_RAM(FLASH_Status_T FLASH_WaitForLastOperation(FLASH_MemType_T FLASH_MemType))
{
