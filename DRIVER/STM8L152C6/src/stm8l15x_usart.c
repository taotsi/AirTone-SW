...
/**
  ...
  * @retval None
  */
void USART_Init(USART_T* USARTx, uint32_t BaudRate, USART_WordLength_T
                USART_WordLength, USART_StopBits_T USART_StopBits,
                USART_Parity_T USART_Parity,  USART_Mode_T USART_Mode)
{
...
/**
  ...
  * @retval None
  */
void USART_ClockInit(USART_T* USARTx, USART_Clock_T USART_Clock,
                     USART_CPOL_T USART_CPOL, USART_CPHA_T USART_CPHA,
                     USART_LastBit_T USART_LastBit)
{
  /* Check the parameters */
...
/**
  ...
  * @retval None
  */
void USART_Cmd(USART_T* USARTx, FunctionalState NewState)
{
  if (NewState != DISABLE)
  {
...
/**
  ...
  * @retval None
  */
void USART_SetPrescaler(USART_T* USARTx, uint8_t USART_Prescaler)
{
...
/**
  ...
  * @retval None
  */
void USART_SendBreak(USART_T* USARTx)
{
...
/**
  ...
  */
uint8_t USART_ReceiveData8(USART_T* USARTx)
{
  return USARTx->DR;
}
...
/**
  ...
  * @retval The received data.
  */
uint16_t USART_ReceiveData9(USART_T* USARTx)
{
  uint16_t temp = 0;
...
/**
  ...
  * @retval None
  */
void USART_SendData8(USART_T* USARTx, uint8_t Data)
{
  /* Transmit Data */
  USARTx->DR = Data;
}
...
/**
  ...
  * @retval None
  */
void USART_SendData9(USART_T* USARTx, uint16_t Data)
{
...
/**
  ...
  * @retval None
  */
void USART_ReceiverWakeUpCmd(USART_T* USARTx, FunctionalState NewState)
{
...
/**
  ...
  * @retval None
  */
void USART_SetAddress(USART_T* USARTx, uint8_t USART_Address)
{
...
/**
  ...
  * @retval None
  */
void USART_WakeUpConfig(USART_T* USARTx, USART_WakeUp_T USART_WakeUp)
{
...
/**
  ...
  * @retval None
  */
void USART_HalfDuplexCmd(USART_T* USARTx, FunctionalState NewState)
{
  assert_param(IS_FUNCTIONAL_STATE(NewState));
...
/**
  ...
  * @retval None
  */
void USART_SmartCardCmd(USART_T* USARTx, FunctionalState NewState)
{
  assert_param(IS_FUNCTIONAL_STATE(NewState));
...
/**
  ...
  * @retval None
  */
void USART_SmartCardNACKCmd(USART_T* USARTx, FunctionalState NewState)
{
  assert_param(IS_FUNCTIONAL_STATE(NewState));
...
/**
  ...
  * @retval None
  */
void USART_SetGuardTime(USART_T* USARTx, uint8_t USART_GuardTime)
{
...
/**
  ...
  * @retval None
  */
void USART_IrDAConfig(USART_T* USARTx, USART_IrDAMode_T USART_IrDAMode)
{
...
/**
  ...
  * @retval None
  */
void USART_IrDACmd(USART_T* USARTx, FunctionalState NewState)
{
...
/**
  ...
  * @retval None
  */
void USART_DMACmd(USART_T* USARTx, USART_DMAReq_T USART_DMAReq,
...
@verbatim   
 ...
 ===============================================================================  
  ...
  In this Mode it is advised to use the following functions:
      - FlagStatus USART_GetFlagStatus(USART_T* USARTx, USART_FLAG_T USART_FLAG);
      - void USART_ClearFlag(USART_T* USARTx, USART_FLAG_T USART_FLAG);
  ...
  In this Mode it is advised to use the following functions:
     - void USART_ITConfig(USART_T* USARTx, USART_IT_T USART_IT, FunctionalState
                      		 NewState);
     - ITStatus USART_GetITStatus(USART_T* USARTx, USART_IT_T USART_IT);
     - void USART_ClearITPendingBit(USART_T* USARTx, USART_IT_T USART_IT);
  ...
  In this Mode it is advised to use the following function:
     - void USART_DMACmd(USART_T* USARTx, uint16_t USART_DMAReq, FunctionalState NewState);
...
/**
  ...
  * @retval None
  */
void USART_ITConfig(USART_T* USARTx, USART_IT_T USART_IT, FunctionalState NewState)
{
