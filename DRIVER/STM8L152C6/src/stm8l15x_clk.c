...
/**
  ...
  * @retval None
  */
void CLK_HSEConfig(CLK_HSE_T CLK_HSE)
{
  /* Check the parameters */
...
/**
  ...
  * @retval None
  */
void CLK_LSEConfig(CLK_LSE_T CLK_LSE)
{
  /* Check the parameters */
...
/**
  ...
  * @retval None
  */
void CLK_CCOConfig(CLK_CCOSource_T CLK_CCOSource, CLK_CCODiv_T CLK_CCODiv)
{
...
/**
  ...
  * @retval None
  */
void CLK_SYSCLKSourceConfig(CLK_SYSCLKSource_T CLK_SYSCLKSource)
{
  /* check teh parameters */
...
/**
  ...
  */
CLK_SYSCLKSource_T CLK_GetSYSCLKSource(void)
{
  return ((CLK_SYSCLKSource_T)(CLK->SCSR));
}
...
uint32_t CLK_GetClockFreq(void)
{
  ...
  CLK_SYSCLKSource_T clocksource = CLK_SYSCLKSource_HSI;
  uint8_t tmp = 0, presc = 0;

  /* Get SYSCLK source. */
  clocksource = (CLK_SYSCLKSource_T)CLK->SCSR;
...
/**
  ...
  * @retval None
  */
void CLK_SYSCLKDivConfig(CLK_SYSCLKDiv_T CLK_SYSCLKDiv)
{
  /* check the parameters */
...
/**
  ...
  * @retval None
  */
void CLK_RTCClockConfig(CLK_RTCCLKSource_T CLK_RTCCLKSource, CLK_RTCCLKDiv_T CLK_RTCCLKDiv)
{
  /* check the parameters */
...
/**
  ...
  * @retval None
  */
void CLK_BEEPClockConfig(CLK_BEEPCLKSource_T CLK_BEEPCLKSource)
{
  /* check the parameters */
...
* @brief  Enables or disables the specified peripheral clock.
  ...
  * @retval None
  */
void CLK_PeripheralClockConfig(CLK_Peripheral_T CLK_Peripheral, FunctionalState NewState)
{
  uint8_t reg = 0;
...
/**
  ...
  *         This parameter can be a value of @ref CLK_Halt_T.
  * @param  NewState : Specifies the System clock (SYSCLK) state in active halt mode.
  *         This parameter can be ENABLE or DISABLE.
  * @retval None
  */
void CLK_HaltConfig(CLK_Halt_T CLK_Halt, FunctionalState NewState)
{
  /* check the parameters */
...
@endverbatim
  ...
  * @retval None
  */
void CLK_ITConfig(CLK_IT_T CLK_IT, FunctionalState NewState)
{
...
/**
  ...
  */
FlagStatus CLK_GetFlagStatus(CLK_FLAG_T CLK_FLAG)
{
  uint8_t reg = 0;
  uint8_t pos = 0;
...
/**
  ...
  */
ITStatus CLK_GetITStatus(CLK_IT_T CLK_IT)
{
...
/**
  ...
  * @retval None
  */
void CLK_ClearITPendingBit(CLK_IT_T CLK_IT)
{
