...
*         This parameter can be one of the @ref RTC_Format_T enumeration.
...
*/
ErrorStatus RTC_SetTime(RTC_Format_T RTC_Format,
...
*/
void RTC_GetTime(RTC_Format_T RTC_Format,
                 RTC_TimeTypeDef* RTC_TimeStruct)
{
  uint8_t  tmpreg = 0;
  ...
  /* Get RTC H12 state */
  RTC_TimeStruct->RTC_H12 = (RTC_H12_T)(tmpreg & RTC_TR3_PM);
...
*/
ErrorStatus RTC_SetDate(RTC_Format_T RTC_Format,
                        RTC_DateTypeDef* RTC_DateStruct)
{
  ...
  {
    RTC_DateStruct->RTC_Month = (RTC_Month_T)((RTC_DateStruct->RTC_Month & (uint8_t)~(TEN_VALUE_BCD)) + TEN_VALUE_BIN);
  }
...
* @retval None
*/
void RTC_GetDate(RTC_Format_T RTC_Format,
                 RTC_DateTypeDef* RTC_DateStruct)
{
  uint8_t tmpreg = 0;
  ...
  RTC_DateStruct->RTC_Month = (RTC_Month_T)(tmpreg & (uint8_t)(RTC_DR2_MT | RTC_DR2_MU));
  RTC_DateStruct->RTC_WeekDay = (RTC_Weekday_T)((uint8_t)((uint8_t)tmpreg & (uint8_t)(RTC_DR2_WDU)) >> (uint8_t)5);
  ...
  if (RTC_Format == RTC_Format_BIN)
  {
    ...
    RTC_DateStruct->RTC_Month = (RTC_Month_T)Bcd2ToByte((uint8_t)RTC_DateStruct->RTC_Month);
...
/**
  ...
  * @retval None.
  */
void RTC_SetAlarm(RTC_Format_T RTC_Format,
...
/**
  ...
  * @retval None
  */
void RTC_GetAlarm(RTC_Format_T RTC_Format,
                  RTC_AlarmTypeDef* RTC_AlarmStruct)
{
  uint8_t tmpreg1 = 0;
  uint8_t tmpreg2 = 0;
  ...
  RTC_AlarmStruct->RTC_AlarmTime.RTC_H12 = (RTC_H12_T)((uint8_t)tmpreg3 & (uint8_t)RTC_ALRMAR3_PM);
  ...
  RTC_AlarmStruct->RTC_AlarmDateWeekDaySel = (RTC_AlarmDateWeekDaySel_T)((uint8_t)tmpreg4 & (uint8_t)RTC_ALRMAR4_WDSEL);
...
*         This parameter can be one of the @ref RTC_AlarmSubSecondMask_T enumeration.
* @retval An ErrorStatus enumeration value:
...
ErrorStatus RTC_AlarmSubSecondConfig(uint16_t RTC_AlarmSubSecondValue,
                                     RTC_AlarmSubSecondMask_T RTC_AlarmSubSecondMask)
{
...
/**
  ...
  *         this parameter  can be one of the @ref RTC_WakeupClockSrc_T enumeration.
  * @retval None
  */
void RTC_WakeUpClockConfig(RTC_WakeUpClock_T RTC_WakeUpClock)
{
...
/**
  ...
  *         This parameter can be one of the @ref RTC_DayLightSaving_T 
  *         enumeration.
  * @param  RTC_StoreOperation: the day light saving store operation
  *         This parameter can be one of the @ref RTC_StoreOperation_T 
  *         enumeration.
  * @retval None
  */
void RTC_DayLightSavingConfig(RTC_DayLightSaving_T RTC_DayLightSaving,
                              RTC_StoreOperation_T RTC_StoreOperation)
{
  /* Check the parameters */
...
/**
  ...
  *         the @ref RTC_StoreOperation_T enumeration.
  */
RTC_StoreOperation_T  RTC_GetStoreOperation(void)
{
  /* Return the stored operation*/
  return (RTC_StoreOperation_T)(RTC->CR3 & RTC_CR3_BCK);
}
...
/**
  ...
  *         @ref RTC_OutputSel_T enumeration.
  * @param  RTC_OutputPolarity: Specifies the polarity of the output signal.
  *         This parameter can be one parameter from the 
  *         @ref RTC_OutputPolarity_T enumeration.
  * @retval None
  */
void RTC_OutputConfig(RTC_Output_T RTC_Output,
                      RTC_OutputPolarity_T RTC_OutputPolarity)
{
  /* Check the parameters */
...
*         This parameter can be one parameter from the @ref RTC_ShiftAdd1S_T
*         enumeration.
...
*/
ErrorStatus RTC_SynchroShiftConfig(RTC_ShiftAdd1S_T RTC_ShiftAdd1S,
...
*         the @ref RTC_SmoothCalibPeriod_T enumeration.
* @param  RTC_SmoothCalibPlusPulses : Select to Set or reset the CALP bit.
*         This parameter can be one parameter from the
*         @ref RTC_SmoothCalibPlusPulses_T enumeration.
...
*/
ErrorStatus RTC_SmoothCalibConfig(RTC_SmoothCalibPeriod_T RTC_SmoothCalibPeriod,
                                  RTC_SmoothCalibPlusPulses_T RTC_SmoothCalibPlusPulses,
...
*         This parameter can be one parameter from the
*         @ref RTC_CalibOutput_T enumeration.
* @retval None
*/
void RTC_CalibOutputConfig(RTC_CalibOutput_T RTC_CalibOutput)
{
  /* Check the parameters */
...
*         This parameter can be one parameter from the @ref RTC_Tamper_T
*         enumeration.
* @param  RTC_TamperLevel: Select the tamper Sensitive Level.
*         This parameter can be one parameter from the 
*         @ref RTC_TamperLevel_T enumeration.
* @retval None
*/
void RTC_TamperLevelConfig(RTC_Tamper_T RTC_Tamper,
                           RTC_TamperLevel_T RTC_TamperLevel)
{
  /* Check the parameters */
...
/**
  ...
  *         This parameter can be one parameter from the
  *         @ref RTC_TamperFilter_T enumeration.
  * @retval None
  */
void RTC_TamperFilterConfig(RTC_TamperFilter_T RTC_TamperFilter)
{
...
/**
  ...
  *         This parameter can be one parameter from the
  *         @ref RTC_TamperSamplingFreq_T enumeration.
  * @retval None
  */
void RTC_TamperSamplingFreqConfig(RTC_TamperSamplingFreq_T RTC_TamperSamplingFreq)
{
  /* Check the parameters */
...
*         Precharge Duration.
*         This parameter can be one parameter from the
*         @ref RTC_TamperPrechargeDuration_T enumeration.
* @retval None
*/
void RTC_TamperPinsPrechargeDuration(RTC_TamperPrechargeDuration_T RTC_TamperPrechargeDuration)
{
  /* Check the parameters */
...
* @retval None
*/
void RTC_TamperCmd(RTC_Tamper_T RTC_Tamper,
...
* @retval None
*/
void RTC_ITConfig(RTC_IT_T RTC_IT, FunctionalState NewState)
{
  /* Check the parameters */
...
*         This parameter can be one of the @ref RTC_Flag_T enumeration.
* @retval Status of RTC_FLAG (SET or RESET)
*/
FlagStatus RTC_GetFlagStatus(RTC_Flag_T RTC_FLAG)
{
...
*         This parameter can be any combination of the @ref RTC_Flag_T
*         enumeration.
* @retval None
*/
void RTC_ClearFlag(RTC_Flag_T RTC_FLAG)
{
  /* Check the parameters */
...
*         This parameter can be one of the @ref RTC_IT_T enumeration.
* @retval Status of RTC_IT (SET or RESET).
*/
ITStatus RTC_GetITStatus(RTC_IT_T RTC_IT)
{
...
*         This parameter can be any combination of the @ref RTC_IT_T
*         enumeration.
* @retval None
*/
void RTC_ClearITPendingBit(RTC_IT_T RTC_IT)
{
  /* Check the parameters */
