...
/**
  ...
  * @retval None.
  */
void COMP_Init(COMP_InvertingInput_T COMP_InvertingInput,
               COMP_OutputSelect_T COMP_OutputSelect, COMP_Speed_T COMP_Speed)
{
...
/**
  ...
  * @retval None.
  */
void COMP_EdgeConfig(COMP_Selection_T COMP_Selection, COMP_Edge_T COMP_Edge)
{
  /* Check the parameters */
...
/**
  ...
  */
COMP_OutputLevel_T COMP_GetOutputLevel(COMP_Selection_T COMP_Selection)
{
  uint8_t compout;
  ...
  if (COMP_Selection == COMP_Selection_COMP1)
  {
    ...
    if ((COMP->CSR1 & COMP_CSR1_CMP1OUT) != (uint8_t) RESET)
    {
      ...
      compout = (COMP_OutputLevel_T) COMP_OutputLevel_High;
    }
    /* comparator 1 output level is low */
    else
    {
      /* Get Comparator 1 output level */
      compout = (COMP_OutputLevel_T) COMP_OutputLevel_Low;
    }
  }
  ...
  return (COMP_OutputLevel_T)(compout);
}
...
/**
  ...
  * @retval None
  */
void COMP_TriggerConfig(COMP_TriggerGroup_T COMP_TriggerGroup,
                        COMP_TriggerPin_T COMP_TriggerPin,
...
/**
  ...
  * @retval None
  */
void COMP_ITConfig(COMP_Selection_T COMP_Selection, FunctionalState NewState)
{
  /* Check the parameters */
  assert_param(IS_COMP_ALL_PERIPH(COMP_Selection));
  assert_param(IS_FUNCTIONAL_STATE(NewState));
...
/**
  ...
  */
FlagStatus COMP_GetFlagStatus(COMP_Selection_T COMP_Selection)
{
...
/**
  ...
  * @retval None.
  */
void COMP_ClearFlag(COMP_Selection_T COMP_Selection)
{
  /* Check the parameters */
  assert_param(IS_COMP_ALL_PERIPH(COMP_Selection));
...
/**
  ...
  */
ITStatus COMP_GetITStatus(COMP_Selection_T COMP_Selection)
{
...
/**
  ...
  * @retval None
  */
void COMP_ClearITPendingBit(COMP_Selection_T COMP_Selection)
{
  /* Check the parameters */
  assert_param(IS_COMP_ALL_PERIPH(COMP_Selection));
