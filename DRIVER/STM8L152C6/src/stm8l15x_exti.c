...
/**
  ...
  * @retval None
  */
void EXTI_SetPinSensitivity(EXTI_Pin_T EXTI_Pin, EXTI_Trigger_T EXTI_Trigger)
{
...
/**
  ...
  * @retval None
  */
void EXTI_SelectPort(EXTI_Port_T EXTI_Port)
{
...
/**
  ...
  * @retval None
  */
void EXTI_SetHalfPortSelection(EXTI_HalfPort_T EXTI_HalfPort,
...
/**
  ...
  * @retval None
  */
void EXTI_SetPortSensitivity(EXTI_Port_T EXTI_Port,
...
/**
  ...
  */
EXTI_Trigger_T EXTI_GetPinSensitivity(EXTI_Pin_T EXTI_Pin)
{
  uint8_t value = 0;
...
/**
  ...
  * @retval The external interrupt sensitivity of the selected port.
  */
EXTI_Trigger_T EXTI_GetPortSensitivity(EXTI_Port_T EXTI_Port)
{
  ...
  return((EXTI_Trigger_T)portsensitivity);
}
...
/**
  ...
  */
ITStatus EXTI_GetITStatus(EXTI_IT_T EXTI_IT)
{
...
/**
  ...
  * @retval None
  */
void EXTI_ClearITPendingBit(EXTI_IT_T EXTI_IT)
{
