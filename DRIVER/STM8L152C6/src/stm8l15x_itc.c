 ...
 */
ITC_PriorityLevel_T ITC_GetSoftwarePriority(IRQn_T IRQn)
{
  uint8_t Value = 0;
  uint8_t Mask = 0;
 ...
 defined (STM8AL31_L_MD) || defined (STM8L05X_LD_VL)
  ...
  return((ITC_PriorityLevel_T)Value);
...
/**
  ...
  * @retval None
  */
void ITC_SetSoftwarePriority(IRQn_T IRQn, ITC_PriorityLevel_T ITC_PriorityLevel)
{
  uint8_t Mask = 0;
