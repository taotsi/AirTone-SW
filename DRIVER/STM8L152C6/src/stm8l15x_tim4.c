...
/**
  ...
  * @retval None
  */
void TIM4_TimeBaseInit(TIM4_Prescaler_T TIM4_Prescaler,
                       uint8_t TIM4_Period)
{
...
/**
  ...
  * @retval None
  */
void TIM4_PrescalerConfig(TIM4_Prescaler_T Prescaler,
                          TIM4_PSCReloadMode_T TIM4_PSCReloadMode)
{
...
/**
  ...
  */
TIM4_Prescaler_T TIM4_GetPrescaler(void)
{
  /* Get the Prescaler Register value */
  return ((TIM4_Prescaler_T)TIM4->PSCR);
}
...
/**
  ...
  * @retval None
  */
void TIM4_UpdateRequestConfig(TIM4_UpdateSource_T TIM4_UpdateSource)
{
  /* Check the parameters */
...
/**
  ...
  * @retval None
  */
void TIM4_SelectOnePulseMode(TIM4_OPMode_T TIM4_OPMode)
{
  /* Check the parameters */
...
/**
  ...
  * @retval None
  */
void TIM4_ITConfig(TIM4_IT_T TIM4_IT, FunctionalState NewState)
{
  /* Check the parameters */
...
/**
  ...
  * @retval None
  */
void TIM4_GenerateEvent(TIM4_EventSource_T TIM4_EventSource)
{
  /* Check the parameters */
...
/**
  ...
  */
FlagStatus TIM4_GetFlagStatus(TIM4_FLAG_T TIM4_FLAG)
{
...
/**
  ...
  * @retval None
  */
void TIM4_ClearFlag(TIM4_FLAG_T TIM4_FLAG)
{
  /* Check the parameters */
...
ITStatus TIM4_GetITStatus(TIM4_IT_T TIM4_IT)
{
...
/**
  ...
  * @retval None
  */
void TIM4_ClearITPendingBit(TIM4_IT_T TIM4_IT)
{
  /* Check the parameters */
  assert_param(IS_TIM4_IT(TIM4_IT));
...
/**
  ...
  * @retval None
  */
void TIM4_DMACmd( TIM4_DMASource_T TIM4_DMASource, FunctionalState NewState)
{
  /* Check the parameters */
  assert_param(IS_FUNCTIONAL_STATE(NewState));
...
/**
  ...
  * @retval None
  */
void TIM4_SelectInputTrigger(TIM4_TRGSelection_T TIM4_InputTriggerSource)
{
  uint8_t tmpsmcr = 0;
...
/**
  ...
  * @retval None
  */
void TIM4_SelectOutputTrigger(TIM4_TRGOSource_T TIM4_TRGOSource)
{
  uint8_t tmpcr2 = 0;
...
/**
  ...
  * @retval None
  */
void TIM4_SelectSlaveMode(TIM4_SlaveMode_T TIM4_SlaveMode)
{
  uint8_t tmpsmcr = 0;
