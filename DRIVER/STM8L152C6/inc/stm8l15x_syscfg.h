...
/**
  * @brief Macro used by the assert function in order to check the different
  * values of @ref RI_AnalogSwitch_T enum.
  */
...
/**
  * @brief Macro used by the assert function in order to check the different
  * values of @ref RI_IOSwitch_T enum.
  */
...
/**
  * @brief Macro used by the assert function in order to check the different
  * values of @ref REMAP_Pin_T enum.
  */
...
/**
  * @brief Macro used by the assert function in order to check the different
  * values of the @ref REMAP_DMAChannel_T enum.
  */
...
void SYSCFG_RITIMInputCaptureConfig(RI_InputCapture_T RI_InputCapture,
                                    RI_InputCaptureRouting_T RI_InputCaptureRouting);
void SYSCFG_RIAnalogSwitchConfig(RI_AnalogSwitch_T RI_AnalogSwitch,
                                 FunctionalState NewState);
void SYSCFG_RIIOSwitchConfig(RI_IOSwitch_T RI_IOSwitch, FunctionalState NewState);
void SYSCFG_RIResistorConfig(RI_Resistor_T RI_Resistor, FunctionalState NewState);

/* SYSCFG configuration *******************************************************/
void SYSCFG_REMAPDeInit(void);
void SYSCFG_REMAPPinConfig(REMAP_Pin_T REMAP_Pin, FunctionalState NewState);
void SYSCFG_REMAPDMAChannelConfig(REMAP_DMAChannel_T REMAP_DMAChannel);
