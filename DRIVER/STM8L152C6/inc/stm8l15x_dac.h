...
void DAC_Init(DAC_Channel_T DAC_Channel,
              DAC_Trigger_T DAC_Trigger,
              DAC_OutputBuffer_T DAC_OutputBuffer);
void DAC_Cmd(DAC_Channel_T DAC_Channel, FunctionalState NewState);
void DAC_SoftwareTriggerCmd(DAC_Channel_T DAC_Channel, FunctionalState NewState);
void DAC_DualSoftwareTriggerCmd(FunctionalState NewState);
void DAC_WaveGenerationCmd(DAC_Channel_T DAC_Channel, DAC_Wave_T DAC_Wave, FunctionalState NewState);
void DAC_SetNoiseWaveLFSR(DAC_Channel_T DAC_Channel, DAC_LFSRUnmask_T DAC_LFSRUnmask);
void DAC_SetTriangleWaveAmplitude(DAC_Channel_T DAC_Channel, DAC_TriangleAmplitude_T DAC_TriangleAmplitude);
void DAC_SetChannel1Data(DAC_Align_T DAC_Align, uint16_t DAC_Data);
void DAC_SetChannel2Data(DAC_Align_T DAC_Align, uint16_t DAC_Data);
void DAC_SetDualChannelData(DAC_Align_T DAC_Align, uint16_t DAC_Data2, uint16_t DAC_Data1);
uint16_t DAC_GetDataOutputValue(DAC_Channel_T DAC_Channel);

/* DMA management function ***************************************************/                            
void DAC_DMACmd(DAC_Channel_T DAC_Channel, FunctionalState NewState);

/* Interrupts and flags management functions **********************************/
void DAC_ITConfig(DAC_Channel_T DAC_Channel, DAC_IT_T DAC_IT, FunctionalState NewState);
FlagStatus DAC_GetFlagStatus(DAC_Channel_T DAC_Channel, DAC_FLAG_T DAC_FLAG);
void DAC_ClearFlag(DAC_Channel_T DAC_Channel, DAC_FLAG_T DAC_FLAG);
ITStatus DAC_GetITStatus(DAC_Channel_T DAC_Channel, DAC_IT_T DAC_IT);
void DAC_ClearITPendingBit(DAC_Channel_T DAC_Channel, DAC_IT_T DAC_IT);
