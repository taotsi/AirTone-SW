...
void ADC_DeInit(ADC_T* ADCx);

/* Initialization and Configuration functions *********************************/ 
void ADC_Init(ADC_T* ADCx,
              ADC_ConversionMode_T ADC_ConversionMode,
              ADC_Resolution_T ADC_Resolution,
              ADC_Prescaler_T ADC_Prescaler);
void ADC_Cmd(ADC_T* ADCx, FunctionalState NewState);
void ADC_SoftwareStartConv(ADC_T* ADCx);
void ADC_ExternalTrigConfig(ADC_T* ADCx,
                            ADC_ExtEventSelection_T ADC_ExtEventSelection,
                            ADC_ExtTRGSensitivity_T ADC_ExtTRGSensitivity);
                            
/* Analog Watchdog configuration functions ************************************/
void ADC_AnalogWatchdogChannelSelect(ADC_T* ADCx,
                                     ADC_AnalogWatchdogSelection_T ADC_AnalogWatchdogSelection);
void ADC_AnalogWatchdogThresholdsConfig(ADC_T* ADCx, uint16_t HighThreshold,
                                        uint16_t LowThreshold);
void ADC_AnalogWatchdogConfig(ADC_T* ADCx,
                              ADC_AnalogWatchdogSelection_T ADC_AnalogWatchdogSelection,
...
void ADC_ChannelCmd(ADC_T* ADCx, ADC_Channel_T ADC_Channels,
                    FunctionalState NewState);

void ADC_SamplingTimeConfig(ADC_T* ADCx, ADC_Group_T ADC_GroupChannels,
                            ADC_SamplingTime_T ADC_SamplingTime);
void ADC_SchmittTriggerConfig(ADC_T* ADCx, ADC_Channel_T ADC_Channels,
                              FunctionalState NewState);
...
void ADC_DMACmd(ADC_T* ADCx, FunctionalState NewState);

/* Interrupts and flags management functions **********************************/
void ADC_ITConfig(ADC_T* ADCx, 
                  ADC_IT_T ADC_IT, 
                  FunctionalState NewState);
FlagStatus ADC_GetFlagStatus(ADC_T* ADCx, ADC_FLAG_T ADC_FLAG);
void ADC_ClearFlag(ADC_T* ADCx, ADC_FLAG_T ADC_FLAG);
ITStatus ADC_GetITStatus(ADC_T* ADCx, ADC_IT_T ADC_IT);
void ADC_ClearITPendingBit(ADC_T* ADCx, ADC_IT_T ADC_IT);
