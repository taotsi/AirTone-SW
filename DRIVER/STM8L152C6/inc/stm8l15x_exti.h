...
void EXTI_SetHalfPortSelection(EXTI_HalfPort_T EXTI_HalfPort, FunctionalState NewState);
void EXTI_SetPortSensitivity(EXTI_Port_T EXTI_Port, EXTI_Trigger_T EXTI_Trigger);
