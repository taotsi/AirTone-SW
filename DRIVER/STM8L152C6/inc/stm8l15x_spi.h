...
void SPI_Init(SPI_T* SPIx, SPI_FirstBit_T SPI_FirstBit,
              SPI_BaudRatePrescaler_T SPI_BaudRatePrescaler,
              SPI_Mode_T SPI_Mode, SPI_CPOL_T SPI_CPOL,
              SPI_CPHA_T SPI_CPHA, SPI_DirectionMode_T SPI_Data_Direction,
              SPI_NSS_T SPI_Slave_Management, uint8_t CRCPolynomial);
void SPI_Cmd(SPI_T* SPIx, FunctionalState NewState);
void SPI_NSSInternalSoftwareCmd(SPI_T* SPIx, FunctionalState NewState);
void SPI_BiDirectionalLineConfig(SPI_T* SPIx, SPI_Direction_T SPI_Direction);

/* Data transfers functions ***************************************************/
void SPI_SendData(SPI_T* SPIx, uint8_t Data);
uint8_t SPI_ReceiveData(SPI_T* SPIx);

/* Hardware CRC Calculation functions *****************************************/
void SPI_TransmitCRC(SPI_T* SPIx);
void SPI_CalculateCRCCmd(SPI_T* SPIx, FunctionalState NewState);
uint8_t SPI_GetCRC(SPI_T* SPIx, SPI_CRC_T SPI_CRC);
void SPI_ResetCRC(SPI_T* SPIx);
uint8_t SPI_GetCRCPolynomial(SPI_T* SPIx);

/* DMA transfer management functions *****************************************/
void SPI_DMACmd(SPI_T* SPIx, SPI_DMAReq_T SPI_DMAReq, FunctionalState NewState);

/* Interrupts and flags management functions **********************************/
void SPI_ITConfig(SPI_T* SPIx, SPI_IT_T SPI_IT, FunctionalState NewState);
FlagStatus SPI_GetFlagStatus(SPI_T* SPIx, SPI_FLAG_T SPI_FLAG);
void SPI_ClearFlag(SPI_T* SPIx, SPI_FLAG_T SPI_FLAG);
ITStatus SPI_GetITStatus(SPI_T* SPIx, SPI_IT_T SPI_IT);
void SPI_ClearITPendingBit(SPI_T* SPIx, SPI_IT_T SPI_IT);
