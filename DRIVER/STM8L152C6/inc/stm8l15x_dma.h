...
void DMA_DeInit(DMA_Channel_T* DMA_Channelx);

/* Initialization and Configuration functions *********************************/
void DMA_Init(DMA_Channel_T* DMA_Channelx,
              uint32_t DMA_Memory0BaseAddr,
              uint16_t DMA_PeripheralMemory1BaseAddr,
              uint8_t DMA_BufferSize,
              DMA_DIR_T DMA_DIR,
              DMA_Mode_T DMA_Mode,
              DMA_MemoryIncMode_T DMA_MemoryIncMode,
              DMA_Priority_T DMA_Priority,
              DMA_MemoryDataSize_T DMA_MemoryDataSize );
void DMA_GlobalCmd(FunctionalState NewState);
void DMA_Cmd(DMA_Channel_T* DMA_Channelx, FunctionalState NewState);
void DMA_SetTimeOut(uint8_t DMA_TimeOut);

/* Data Counter functions *****************************************************/
void DMA_SetCurrDataCounter(DMA_Channel_T* DMA_Channelx, uint8_t DataNumber);
uint8_t DMA_GetCurrDataCounter(DMA_Channel_T* DMA_Channelx);

/* Interrupts and flags management functions **********************************/
void DMA_ITConfig(DMA_Channel_T* DMA_Channelx, DMA_ITx_T DMA_ITx, FunctionalState NewState);
FlagStatus DMA_GetFlagStatus(DMA_FLAG_T DMA_FLAG);
void DMA_ClearFlag(DMA_FLAG_T DMA_FLAG);
ITStatus DMA_GetITStatus(DMA_IT_T DMA_IT);
void DMA_ClearITPendingBit(DMA_IT_T DMA_IT);
