...
#define RST                         ((RST_T *) RST_BASE)
#define PWR                         ((PWR_T *) PWR_BASE)
#define CLK                         ((CLK_T *) CLK_BASE)
#define CSSLSE                      ((CSSLSE_T *) CSSLSE_BASE)
#define WWDG                        ((WWDG_T *) WWDG_BASE)
#define IWDG                        ((IWDG_T *) IWDG_BASE)
#define WFE                         ((WFE_T *) WFE_BASE)
#define BEEP                        ((BEEP_T *) BEEP_BASE)
...
#define ITC                         ((ITC_T *) ITC_BASE)
#define DAC                         ((DAC_T *) DAC_BASE)
#define DMA1                        ((DMA_T *) DMA1_BASE)
#define DMA1_Channel0               ((DMA_Channel_T *) DMA1_Channel0_BASE)
