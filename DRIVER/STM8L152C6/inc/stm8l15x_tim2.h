...
void TIM2_TimeBaseInit(TIM2_Prescaler_T TIM2_Prescaler,
                       TIM2_CounterMode_T TIM2_CounterMode, uint16_t TIM2_Period);
...
void TIM2_SelectOCxM(TIM2_Channel_T TIM2_Channel, TIM2_OCMode_T TIM2_OCMode);
...
void TIM2_CCxCmd(TIM2_Channel_T TIM2_Channel, FunctionalState NewState);
