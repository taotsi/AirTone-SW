...
void TIM5_TimeBaseInit(TIM5_Prescaler_T TIM5_Prescaler,
                       TIM5_CounterMode_T TIM5_CounterMode, uint16_t TIM5_Period);
...
void TIM5_SelectOCxM(TIM5_Channel_T TIM5_Channel, TIM5_OCMode_T TIM5_OCMode);
...
void TIM5_CCxCmd(TIM5_Channel_T TIM5_Channel, FunctionalState NewState);
