...
/* AES Configuration **********************************************************/
void AES_OperationModeConfig(AES_Operation_T AES_Operation);
...
void AES_DMAConfig(AES_DMATransfer_T AES_DMATransfer, FunctionalState NewState);

/* Interrupts and flags management functions **********************************/
void AES_ITConfig(AES_IT_T AES_IT, FunctionalState NewState);
FlagStatus AES_GetFlagStatus(AES_FLAG_T AES_FLAG);
void AES_ClearFlag(AES_FLAG_T AES_FLAG);
ITStatus AES_GetITStatus(AES_IT_T AES_IT);
void AES_ClearITPendingBit(AES_IT_T AES_IT);
