...
typedef struct
{
  ...
  RTC_HourFormat_T RTC_HourFormat; /*!< RTC Hour Format */
...
typedef struct
{
  ...
  uint8_t RTC_Seconds;     /*!< RTC Seconds.
                             ...
                             If BCD format is selected, this parameter can
                                be any BCD value from 0x00 to 0x59.*/
  RTC_H12_T RTC_H12;  /*!< RTC 12-hour clock period (AM/PM) */
}
RTC_TimeTypeDef;
...
typedef struct
{
  RTC_Weekday_T  RTC_WeekDay; /*!< The RTC Calender Weekday. */

  RTC_Month_T RTC_Month;      /*!< The RTC Calender Month. */
...
typedef struct
{
  ...
  RTC_AlarmDateWeekDaySel_T RTC_AlarmDateWeekDaySel; /*!< The RTC Alarm Date/WeekDay selection. */
...
ErrorStatus RTC_SetTime(RTC_Format_T RTC_Format, RTC_TimeTypeDef* RTC_TimeStruct);
void RTC_TimeStructInit(RTC_TimeTypeDef* RTC_TimeStruct);
void RTC_GetTime(RTC_Format_T RTC_Format, RTC_TimeTypeDef* RTC_TimeStruct);
uint16_t RTC_GetSubSecond(void);
ErrorStatus RTC_SetDate(RTC_Format_T RTC_Format, RTC_DateTypeDef* RTC_DateStruct);
void RTC_DateStructInit(RTC_DateTypeDef* RTC_DateStruct);
void RTC_GetDate(RTC_Format_T RTC_Format, RTC_DateTypeDef* RTC_DateStruct);

/* Alarm configuration functions  *********************************************/ 
void RTC_SetAlarm(RTC_Format_T RTC_Format,  RTC_AlarmTypeDef* RTC_AlarmStruct);
void RTC_AlarmStructInit(RTC_AlarmTypeDef* RTC_AlarmStruct);
void RTC_GetAlarm(RTC_Format_T RTC_Format,  RTC_AlarmTypeDef* RTC_AlarmStruct);
