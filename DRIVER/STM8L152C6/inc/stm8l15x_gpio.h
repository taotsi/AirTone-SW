...
void GPIO_Init(GPIO_T* GPIOx, uint8_t GPIO_Pin, GPIO_Mode_T GPIO_Mode);
void GPIO_ExternalPullUpConfig(GPIO_T* GPIOx, uint8_t GPIO_Pin, FunctionalState NewState);

/* GPIO Read and Write ********************************************************/
void GPIO_Write(GPIO_T* GPIOx, uint8_t GPIO_PortVal);
void GPIO_WriteBit(GPIO_T* GPIOx, GPIO_Pin_T GPIO_Pin, BitAction GPIO_BitVal);
void GPIO_SetBits(GPIO_T* GPIOx, uint8_t GPIO_Pin);
void GPIO_ResetBits(GPIO_T* GPIOx, uint8_t GPIO_Pin);
void GPIO_ToggleBits(GPIO_T* GPIOx, uint8_t GPIO_Pin);
uint8_t GPIO_ReadInputData(GPIO_T* GPIOx);
uint8_t GPIO_ReadOutputData(GPIO_T* GPIOx);
BitStatus GPIO_ReadInputDataBit(GPIO_T* GPIOx, GPIO_Pin_T GPIO_Pin);
BitStatus GPIO_ReadOutputDataBit(GPIO_T* GPIOx, GPIO_Pin_T GPIO_Pin);
