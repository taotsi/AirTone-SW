...
void LCD_Init(LCD_Prescaler_T LCD_Prescaler, LCD_Divider_T LCD_Divider,
              LCD_Duty_T LCD_Duty, LCD_Bias_T LCD_Bias, LCD_VoltageSource_T LCD_VoltageSource);
void LCD_PortMaskConfig(LCD_PortMaskRegister_T LCD_PortMaskRegister, uint8_t LCD_Mask);
void LCD_Cmd(FunctionalState NewState);
void LCD_HighDriveCmd(FunctionalState NewState);
void LCD_PulseOnDurationConfig(LCD_PulseOnDuration_T LCD_PulseOnDuration);
void LCD_DeadTimeConfig(LCD_DeadTime_T LCD_DeadTime);
void LCD_BlinkConfig(LCD_BlinkMode_T LCD_BlinkMode, LCD_BlinkFrequency_T LCD_BlinkFrequency);
void LCD_ContrastConfig(LCD_Contrast_T LCD_Contrast);

/* LCD RAM memory write functions *********************************************/
void LCD_WriteRAM(LCD_RAMRegister_T LCD_RAMRegister, uint8_t LCD_Data);
void LCD_PageSelect(LCD_PageSelection_T LCD_PageSelection);
